...
namespace MoCashRoCo.Migrations
{
    ...
    [Migration("20260602185204_VerifiedProductImages")]
    partial class VerifiedProductImages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MoCashRoCo.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1597336465111-a392afd218bc?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                            Name = "Selenite Wand",
                            Price = 14.99m,
                            StockQuantity = 60
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1632980205460-e490e885e848?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1593259213062-57b0ce5906cf?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1534883031555-7d18c6cf52e7?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1543384490-fc38bd91de41?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1562162135-9f64f33e623b?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1599139449818-4ca5baa081bd?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1701634441311-e624c7fdfedf?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1620975522168-1ee4ca17ccb5?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1604745372175-27daa24a0a0e?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://images.unsplash.com/photo-1504812333783-63b845853c20?w=600&h=400&fit=crop&auto=format",
                            IsActive = true,
